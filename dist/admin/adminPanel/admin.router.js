...
router.post('/adminDashboard', auth_middleware_1.checkAuthorization, admin_middleware_1.adminRole, admin_controller_1.adminDashboard);
router.post('/vendorProductStatus/:id', auth_middleware_1.checkAuthorization, admin_middleware_1.adminRole, admin_controller_1.vendorProductStatus);
