...
router.post('/addProduct', auth_middleware_1.checkAuthorization, auth_middleware_1.userBlocked, product_middleware_1.vendorRole, product_middleware_1.upload.array('images', 5), product_controller_1.addProduct);
...
router.get('/viewProduct', auth_middleware_1.checkAuthorization, auth_middleware_1.userBlocked, product_middleware_1.vendorRole, product_middleware_1.upload.array('images', 5), product_controller_1.viewProduct);
