...
const addProduct = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const imageUrl = imagePath ? `../../../uploads/${imagePath}` : null;
        ...
        const product = new product_module_1.productModel({ vendorId: userId, name, description, price, stock, category, images: imageUrl ? [imageUrl] : [] });
        yield product.save();
...
const updateProduct = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const productUpdate = yield product_module_1.productModel.findByIdAndUpdate({ _id: id }, { name, description, price, stock, category, images }, { new: true });
