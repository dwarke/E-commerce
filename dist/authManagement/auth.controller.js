...
const register = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { name, email, password, phone, address, genderCategory, role } = req.body;
        ...
        if (role === 'vendor') {
            const user = new auth_module_1.default({ name, email, password: hashPassword, role, phone, address, genderCategory, status: 'pending' });
            yield user.save();
        }
