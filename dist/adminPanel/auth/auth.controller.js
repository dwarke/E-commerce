...
const register = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const user = new auth_module_1.default({ name, email, password: hashPassword, phone, address, genderCategory });
        yield user.save();
...
const login = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (data.role === 'admin') {
            ...
            (0, responseHandler_1.createResponse)(res, 400, false, "You are not admin");
            return;
        }
    }
    catch (error) {
